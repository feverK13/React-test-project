  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.socials}>
        <p className={styles.socialsHeading}>My socials</p>
        ...
        <div className={styles.socialsList}>
          ...
          <a href='' className={styles.socialLink} target='_blank'>
            <svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 24 24'>
              <g fill='none' stroke='currentColor' strokeLinejoin='round' strokeWidth='1.2'>
                <path d='M7 12.75a1.5 1.75 0 1 0 3 0a1.5 1.75 0 1 0-3 0m7 0a1.5 1.75 0 1 0 3 0a1.5 1.75 0 1 0-3 0' />
                <path
                  strokeLinecap='round'
                  d='M9.5 5.5S10.58 5 12 5s2.5.5 2.5.5L15 4c1.755 0 3.06.293 4.5 1c1 1.667 3 6.4 3 12c-1.864 1.924-3.304 2.736-5.5 3l-1.5-2.5c-.5.167-1.9.5-3.5.5s-3-.333-3.5-.5L7 20c-2.196-.264-3.636-1.076-5.5-3c0-5.6 2-10.333 3-12C5.94 4.293 7.245 4 9 4z'
                />
                <path
                  strokeLinecap='round'
                  d='M8.5 17.5c-1.086-.277-2-1-2-1m9 1c1.086-.277 2-1 2-1'
                />
              </g>
            </svg>
          </a>
          <a href='' className={styles.socialLink} target='_blank'>
            <svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 24 24'>
              <g fill='none' stroke='currentColor' strokeLinejoin='round' strokeWidth='1.2'>
                <path d='M1.5 3.5a2 2 0 1 0 4 0a2 2 0 1 0-4 0' />
                <path
